...
const CTASection = () => {
  return (
    <SectionCTA>
      <CTAInner>
        <CTATextBlock>
          <CTATitle>지금, 온라인으로 공간 상담을 시작해보세요.</CTATitle>
          <CTABody>
            번거로운 방문 상담 없이도, 우리 공간에 맞는 견적과 시공 이미지를
            빠르게 확인하실 수 있습니다.
          </CTABody>
        </CTATextBlock>
        <CTAButtons>
          <CTAButtonPrimary>온라인 견적 바로가기</CTAButtonPrimary>
          <CTAButtonSecondary>상담 예약 문의</CTAButtonSecondary>
        </CTAButtons>
      </CTAInner>
    </SectionCTA>
  );
